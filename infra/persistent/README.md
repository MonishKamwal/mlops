...
the data/state and logs buckets, the ECR repo, and the GitHub OIDC trust that
lets CI deploy without stored AWS keys. Applied manually from a laptop —
...
- **Lambda + Function URL** — added in Phase 1, task 4.
